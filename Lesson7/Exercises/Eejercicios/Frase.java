...
public class Frase {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i<TAM;i++){
            frase[i]= JOptionPane.showInputDialog(null, "Introduce la frase que esta en posicion "+i+": ");
        }
    ...
    public void mayorFrase(String [] frase){
        ...
        System.out.println("La frase que esta en la posicion "+posicion+" con valor '"+ masLarga+"' es la palabra mas larga");
    }
    ...
    public void menorFrase(String [] frase){
        ...
        System.out.println("La frase que esta en la posicion "+posicion+" con valor '"+ masCorta+"' es la palabra mas corta");
    }
}
