...
/**
 *
 * Programa que calcula el MCD de 2 números utilizando el algoritmo de Euclides, con 
 * recursividad.
 */
public class MCDRecursivo {
    ...
    public static void main(String[] args) {
        ...
        int numero1;
        int numero2;
        //bucle de validaci?n de los numeros 
    ...
    public int mcd(int mayor, int menor) {
        ...
        if (resto == 0) {
            return menor;//condicion de parada
        }
