 ...
 */
public class MCD {
    //metodo que calcula el maximo comun divisor de numero 1 y numero2 según el algoritmo de Euclides 
    ...
    public int mcd(int numero1, int numero2){
       int resto = 1;
        ...
        return numero2; //devuelvo el máximo comun divisor 
    ...
    public static void main(String[] args) {
        ...
        //preparamos las variables para que numero1 sea el mayor de los dos y asÃ­ el algoritmo funcione
        if(numero1 <= numero2){
            int aux=numero1;
            numero2=numero1;
            numero1=aux;
