...
public class DNI {
    ...
    public static void main(String[] args) {
        ...
        final int  MAX=3; //l?mite de intentos permitidos
        String letras = "TRWAGMYFPDXBNJZSQVHLCKE";
        int contador=0; //contador de intentos fallidos
        char letradni=0; //letra DNI introducida por el usuario
        char letracorrecta = 0; //letra DNI calculadada
        //bucle de validaci?n del dni
        do {
